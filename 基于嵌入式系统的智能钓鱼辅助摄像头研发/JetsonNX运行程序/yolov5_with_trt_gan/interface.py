...
def Motor_level_set(delta):
    ...
    level_angle = delta
    ser.write(("@" + str(int(level_angle)).zfill(3) + str(int(vertical_angle)).zfill(3) + "\r\n").encode())
...
def interface():
    ...
    level_sc = tk.Scale(main_window, label='level_set', from_=0, to=270,
                  ...
                  showvalue=True, tickinterval=90, resolution=1,
...
def Depose():
    global YoloDet, SpiralGan, is_enhance, is_detect, fin_img, cap, is_stop, categories
